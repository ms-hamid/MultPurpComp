        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden p-10 shadow-sm sm:rounded-lg"> 
                ...
                @if($errors->any())
                    ...
                    <div class="py-3 full rounded-3xl bg-red-500 text-white">
                        {{$error}}
                    </div>
                    @endforeach
                @endif
                ...
                <form method="POST" action="{{ route('admin.hero_sections.update', $heroSection) }}" enctype="multipart/form-data"> 
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="subheading" class="block mt-1 w-full" type="text" name="subheading"  required autofocus autocomplete="subheading" value="{{ $heroSection->subheading }}" />
                        <x-input-error :messages="$errors->get('subheading')" class="mt-2" />
                    </div>

                    <div class="mt-4">
                        <x-input-label for="achievement" :value="__('achievement')" />
                        <x-text-input id="achievement" class="block mt-1 w-full" type="text" name="achievement"  required autofocus autocomplete="achievement"
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="path_video" class="block mt-1 w-full" type="text" name="path_video" required autofocus autocomplete="path_video"
